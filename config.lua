...
-- Blocking Scenario from spawning in an Area
Config.BlockPool = {
    {center=vector3(67.74, 122.76, 81.35), min=vector3(86.10, 106.27, 78.47), max=vector3(59.01, 135.10, 87.96), radius=15.0}, -- Go Postal in City
}
