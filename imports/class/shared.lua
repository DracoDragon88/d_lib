...
if not getinfo(1, 'S').source:match('^@@d_lib') then
    dlib.print.warn('d_lib\'s class module is experimental and may break without warning.')
end
...
---@alias DClassConstructor<T> fun(self: T, ...: unknown): nil

---@class DClass
---@field private __index table
---@field protected __name string
---@field protected private? { [string]: unknown }
---@field protected super? DClassConstructor
---@field protected constructor? DClassConstructor
local mixins = {}
local constructors = {}
...
---@param name string
---@param super? S
function dlib.class(name, super)
