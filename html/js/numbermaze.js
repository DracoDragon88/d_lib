...
function CheckMaze() {
    if (wrong === 3) {
        ...
        setTimeout(function() { 
            ...
            ResetNumberMaze();
            $.post(`https://${GetParentResourceName()}/game-callback`, JSON.stringify({ 'success': false, "fails": wrong }));
        }, 4000);
    ...
    if (last_pos === 48) {
        ...
        setTimeout(function() { 
            $(".numbermaze-hack").fadeOut();
            ResetNumberMaze();
            $.post(`https://${GetParentResourceName()}/game-callback`, JSON.stringify({ 'success': true, "fails": wrong }));
        }, 4000);
    }
}
